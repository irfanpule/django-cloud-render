...
class BlenderRender:
    ...
    def _prepare_output_dir(self):
        ...
        self.output_dir = output_project_dir
        self.output_dir_filename = output_project_dir + "/" + self.project.slug
    ...
    def run(self):
        ...
        args = shlex.split(
            f"blender -b {self.filepath} -o {self.output_dir_filename} -s {self.start_frame} -e {self.end_frame} -t {self.total_thread} -a -- --cycles-device {self.option_cycles}")
